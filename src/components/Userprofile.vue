...
const saveChanges = async () => {
  try {
    ...
    // 呼叫 API 更新用戶資料
    const response = await axios.put(`https://view-truth.zeabur.app/api/user/${route.params.id}`, updatedData);
...
const handlePasswordChange = async () => {
  try {
    ...
    // 呼叫 API 更新密碼
    const response = await axios.put(`https://view-truth.zeabur.app/api/user/${route.params.id}/password`, {
